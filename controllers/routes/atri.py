...
class Atri:
	def __init__(self, state: Any):
		...
		self.mail = state["mail"]
		self.mai = state["mai"]
		self.Abtburger = state["Abtburger"]
		self.AbtUs = state["AbtUs"]
	...
	@property
	def Res-x(self):
		self._getter_access_tracker["Res-x"] = {}
		return self._Res-x
	@Res-x.setter
	def Res-x(self, new_state):
		self._setter_access_tracker["Res-x"] = {}
		global default_state
		self._Res-x = Image(new_state, default_state["Res-x"])
	...
	@property
	def mail(self):
		self._getter_access_tracker["mail"] = {}
		return self._mail
	@mail.setter
	def mail(self, new_state):
		self._setter_access_tracker["mail"] = {}
		global default_state
		self._mail = Image(new_state, default_state["mail"])

	@property
	def mai(self):
		self._getter_access_tracker["mai"] = {}
		return self._mai
	@mai.setter
	def mai(self, new_state):
		self._setter_access_tracker["mai"] = {}
		global default_state
		self._mai = TextBox(new_state, default_state["mai"])

	@property
	def Abtburger(self):
		self._getter_access_tracker["Abtburger"] = {}
		return self._Abtburger
	@Abtburger.setter
	def Abtburger(self, new_state):
		self._setter_access_tracker["Abtburger"] = {}
		global default_state
		self._Abtburger = Image(new_state, default_state["Abtburger"])

	@property
	def AbtUs(self):
		self._getter_access_tracker["AbtUs"] = {}
		return self._AbtUs
	@AbtUs.setter
	def AbtUs(self, new_state):
		self._setter_access_tracker["AbtUs"] = {}
		global default_state
		self._AbtUs = TextBox(new_state, default_state["AbtUs"])
